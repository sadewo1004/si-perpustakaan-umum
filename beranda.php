    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Sistem Pendaftaran Mahasiswa Baru</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Sistem Penerimaan Mahasiswa Baru</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">NIK</th><th>Nama Lengkap</th><th>L/P</th><th>Alamat</th><th>No. Telp</th>
                            </tr>
                        </thead>
                        <tbody>
