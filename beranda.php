    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di Sistem Informasi Perpustakaan Umum</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Sistem Perpustakaan</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="20%">Judul Buku</th><th>Pengarang</th><th>Penerbit</th><th width="20%">Jenis Buku</th><th>Keterangan</th>
                            </tr>
                        </thead>
                        <tbody>
